          ...
          >
            <div className="relative z-10">
              ...
              <p className="opacity-90 leading-relaxed mb-6 text-sm">
                Our organic scaling algorithm detected 3 potential indices that
                could reduce query latency by up to 40%.
              </p>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#6b6358]">{p.updated}</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      ...
                      >
                        <span
                          ...
                          style={{
                            background:
                              p.status === "Healthy" ? "#4a7c59" : "#705c30",
                          }}
                        />
                        {p.status}
                      </span>
